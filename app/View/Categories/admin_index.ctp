...
<div id="content">
	<!-- page title -->
		...
		<table cellspacing="0" cellpadding="0" style="width: 100%">
			<tr>
				<td><h2>Manage Categories</h2>
				</td>
				<td class="searches">
					<?php echo $this->Form->input('search_value', array('div'=>false,'label' => false, 'class' => 'curve1 text2','onblur'=>"if(this.value == '') {this.value='Enter Category Name';}",'onfocus'=>"if(this.value == 'Enter Category Name') {this.value='';}",'value'=>'Enter Category Name')); ?>
					<?php
					...
					<div class="submit" style="margin-top:10px;">
						<input onclick="window.location='<?php echo $base_url?>admin/categories/add'" type="button" value="Add" class="curve2 button1">
					</div>
	...
	<table cellspacing="0" cellpadding="0" class="table2 curve1">
		<tr>
			...
			<th>
				<?php echo $this->Paginator->sort('name', 'Category Name');?></th>
		...
		foreach ($categories as $category):
			...
			<tr<?php echo $class;?>>
				...
				<td class="actions">
					...
					<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $category['Category']['id']), null, __('Are you sure you want to delete Category : %s ?', $category['Category']['name'])); ?>
				</td>
			</tr>
			<?php endforeach; ?>

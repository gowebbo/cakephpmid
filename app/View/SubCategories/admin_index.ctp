...
<div id="content">
	<!-- page title -->
		...
		<table cellspacing="0" cellpadding="0" style="width: 100%">
			<tr>
				<td><h2>Manage Sub Categories</h2></td>
				<td class="searches">
					...
					<div class="submit" style="margin-top:10px;">
						<input onclick="window.location='<?php echo $base_url?>admin/sub_categories/add'" type="button" value="Add" class="curve2 button1">
					</div>
				</td>
			</tr>
		</table>
	...
	<table cellspacing="0" cellpadding="0" class="table2 curve1">
		<tr>
			...
			<th>
				<?php echo $this->Paginator->sort('category_id', 'Category');?></th>
			<th>
				<?php echo $this->Paginator->sort('name', 'Sub Category Name');?></th>
		...
		foreach ($data as $SubCategory):
			...
			<tr<?php echo $class;?>>
				...
				<td><?php echo h($SubCategory['Category']['name']); ?>&nbsp;</td>
				...
				<td class="actions">
					...
					<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $SubCategory['SubCategory']['id']), null, __('Are you sure you want to delete Sub Category : %s ?', $SubCategory['SubCategory']['name'])); ?>
				</td>
			</tr>
			<?php endforeach; ?>
			<?php if(count($data)==0){?>

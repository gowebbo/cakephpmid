 <div id="right-container" class="lft">
                ...
                <div class="our-products-head">
                	...
                	<div class="lft">Whole Sale Enquiry</div>
                    <div class="clr"></div>
                </div>
                          ...
                          <tr>
							...
							<?php }?>
						      <table width="100%" border="0" cellspacing="0" cellpadding="5">
                                ...
                                <tr>
                                  <td colspan="2" bgcolor="#3F3F3F" style="padding:10px 0;"><strong>Information</strong></td>
                                </tr>
                                <tr>
								...
								<tr>
                                  <td style="font-weight:normal; text-transform:none; text-align:right;">Company Name : </td>
                                  <td>
								  	<?php echo $this->Form->input('company', array('label' => '','div' => false, 'class' => 'tbox','style'=>'color:black')); ?>
													
								  </td>
                                </tr>
                                <tr>
                                  <td style="font-weight:normal; text-transform:none; text-align:right;">Owner First Name : </td>
                                  <td>
                                ...
                                <tr>
                                  <td style="font-weight:normal; text-transform:none; text-align:right;">Owner Last Name : </td>
                                  <td>
                                ...
                                <tr>
                                  <td style="font-weight:normal; text-transform:none; text-align:right;">Company Address: </td>
                                ...
                                <tr>
								 ...
								 <tr>
                                  ...
                                  <td align="center" style="padding-left:120px;">
								    <?php echo $this->Form->input('message', array('rows'=>'10','cols'=>'20','label' => '','div' => false, 'class' => 'textarea')); ?>

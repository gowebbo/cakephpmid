(function(a){
    a.fn.webwidget_vertical_menu=function(p){
        ...
        var m=p&&p.directory?p.directory:"img";
        var w=a(this);
        f += 'px';
        h += 'px';
        l += 'px';
        ...
        function init(){
            ...
            w.children("ul").children("li").css("border-bottom", h + " " + k + " " + j).css("margin-bottom", r).css("background-color", i);
            ...
            w.find("li:has(ul)").css("background-image","url("+m+"/nav-arrow-right.png)");
    ...
    (function (a) {
        a.fn.webwidget_vertical_menu1 = function (p) {
            ...
            function init() {
                ...
                w.find("li:has(ul)").css("background-image", "url(" + m + "/nav-arrow-left.png)");
